...
RuvSense is the multistatic WiFi sensing subsystem of Wave. It turns raw radio signals from multiple ESP32 sensors into tracked human poses, vital signs, and spatial awareness — all without cameras.
