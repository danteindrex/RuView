...
import { Shield, ShieldAlert, ShieldCheck, Users, AlertCircle, Settings2, Lock, Unlock, Activity, LayoutDashboard, HeartPulse, Box, Settings, Building2, Terminal, Package } from "lucide-react";

type PageId =
  | "dashboard" | "medical" | "security" | "pose3d"
  | "settings" | "users" | "roles" | "tenants" | "sysadmin" | "models";
