#!/usr/bin/env python3
"""
Bridge Nexmon CSI UDP packets to Wave canonical CSI UDP frame format.

Use case:
- Raspberry Pi 4B running Nexmon CSI emits UDP packets on port 5500.
- Wave sensing-server expects canonical binary frames on UDP port 5005.
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Bridge Nexmon CSI UDP packets into Wave ESP32 UDP frames."
    )
