# start-wave.ps1 -- Start the Wave sensing stack (standalone mode).
#
#   .\scripts\start-wave.ps1                  start the sensing server if not running
#   .\scripts\start-wave.ps1 -RegisterStartup also auto-start it at every Windows logon
#   .\scripts\start-wave.ps1 -Unregister      remove the auto-start task
#
