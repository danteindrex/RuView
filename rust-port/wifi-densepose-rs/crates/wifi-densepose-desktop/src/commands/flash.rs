...
/// GitHub repository that publishes the ESP32 firmware releases.
const FIRMWARE_REPO: &str = "danteindrex/RuView";
...
///
/// # Note
/// This assumes the `danteindrex/RuView` release assets are publicly
