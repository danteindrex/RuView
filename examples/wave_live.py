#!/usr/bin/env python3
"""
Wave Live — Ambient Intelligence Dashboard with RuVector Signal Processing

Fuses WiFi CSI (ESP32-S3) + 60 GHz mmWave (MR60BHA2) with signal processing
algorithms ported from Wave's Rust crates:
...
def run_display(hub, duration, interval, mode="vitals"):
    ...
    print("=" * 80)
    if mode == "happiness":
        print("  Wave Live — Happiness + Cognitum Seed Dashboard")
    else:
        print("  Wave Live — Ambient Intelligence + RuVector Signal Processing")
    print("=" * 80)
    print()
...
def main():
    parser = argparse.ArgumentParser(description="Wave Live + RuVector Analysis")
